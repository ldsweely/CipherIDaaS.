 ...
 *
 * @author: shizhao
 * @since: 2020-3-6 15:01
 */
@Service("loginFaildStrategyServiceImpl")
public class LoginFaildStrategy implements DataInitService {
    ...
    public void init(String companyUUid) throws Exception {
        dataInitMapper.loginFaildDataInit(companyUUid);
    }
}
