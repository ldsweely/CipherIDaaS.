 ...
 *
 * @author: shizhao
 * @since: 2020-3-6 16:06
 */
@Service("smsChannelDataInitServiceImpl")
public class SmsChannelDataInitServiceImpl implements DataInitService {
    ...
    public void init(String companyUUid) throws Exception {
        dataInitMapper.smsChannelDataInit(companyUUid);
    }
}
