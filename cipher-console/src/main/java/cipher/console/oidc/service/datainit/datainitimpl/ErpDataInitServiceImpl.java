 ...
 *
 * @author: shizhao
 * @since: 2020-3-6 16:48
 */
@Service("erpDataInitServiceImpl")
public class ErpDataInitServiceImpl implements DataInitService {
    ...
    public void init(String companyUUid) throws Exception {
        dataInitMapper.erpDataInit(companyUUid);
    }
}
